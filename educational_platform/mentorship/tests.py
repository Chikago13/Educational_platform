...
from .serializers import GroupSerializer, TeacherSerializer
...
class UpdateGroupTest(APITestCase):
    ...
    def test_update_group(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertGreater(
            Group.objects.get(id=self.group.id).date_updated, self.group.date_updated
        )
